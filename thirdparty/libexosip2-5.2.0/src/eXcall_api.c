...
int eXosip_call_build_ack(struct eXosip_t *excontext, int tid, osip_message_t **_ack) {
  eXosip_dialog_t *jd = NULL;
  eXosip_call_t *jc = NULL;
  ...
  *_ack = NULL;
  ...
  /* copy all credentials from INVITE! */
  {
    ...
    while (i >= 0 && pa != NULL) {
      ...
      if (i != 0) {
        OSIP_TRACE(osip_trace(__FILE__, __LINE__, OSIP_ERROR, NULL, "[eXosip] cannot copy credentials from INVITE\n"));
        break;
      }
...
int eXosip_call_build_request(struct eXosip_t *excontext, int jid, const char *method, osip_message_t **request) {
  eXosip_dialog_t *jd = NULL;
  eXosip_call_t *jc = NULL;
...
int eXosip_call_send_request(struct eXosip_t *excontext, int jid, osip_message_t *request) {
  eXosip_dialog_t *jd = NULL;
  eXosip_call_t *jc = NULL;
...
static osip_header_t *_eXosip_header_strcasestr(osip_message_t *message, const char *hname, const char *hname_short, const char *value) {
...
int eXosip_call_find_by_replaces(struct eXosip_t *excontext, char *replaces_str) {
  eXosip_call_t *jc = NULL;
  eXosip_dialog_t *jd = NULL;
  char *call_id;
  char *to_tag;
